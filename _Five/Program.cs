...
namespace _Five
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(customers1.customer_name.First() + "  " + customers1.customer_id + "\n" + orders1.customer_id + "  " + orders1.amount + "  " + orders1.order_id);
            Console.WriteLine(customers1.customer_name.Count() + "  " + customers1.customer_id + "\n" + orders3.customer_id + "  " + orders3.amount + "  " + orders3.order_id);
            Console.WriteLine(customers.customer_name.Min() + "  " + customers.customer_id + "\n" + orders2.customer_id + "  " + orders2.amount + "  " + orders2.order_id);
            Console.ReadLine();
        }
    }
}
